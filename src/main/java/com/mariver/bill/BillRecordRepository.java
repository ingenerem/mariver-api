...
//    List<BillRecord> findByBillUserEmailAndPaidFalseAndDueDateBeforeOrderByDueDateAsc(String email, LocalDate today);
//
//    List<BillRecord> findByBillUserEmailAndPaidTrueAndDueDateBetweenOrderByDueDateDesc(String email, LocalDate startOfMonth, LocalDate endOfMonth);
}